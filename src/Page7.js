            ...
            {shapCollaboValues.PositiveFeature.map((feature) => (
              <li key={feature} style={{ listStyleType: 'none' }}>
                <div className={styles.featureContainer}>
                  ...
                  <button style={{ width: '77px', height: '50px', backgroundColor: 'lightblue', marginBottom: '10px', listStyleType: 'none' }} className={styles.featureName}>{feature.shapValue}</button>
